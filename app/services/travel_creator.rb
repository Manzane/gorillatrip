class TravelCreator
  ...
  def save
    ...
    TravelCountry.create(duration: @params[:travel_countries_attributes]["0"][:duration].to_i, travel: @travel, country_id: @params[:travel_countries_attributes]["0"][:country_id].to_i)
